...
function monsterDie() {
  ...
  // monster card drop (from the matching monster; secret cards from bosses)
  if (typeof cardRollDrop === 'function') cardRollDrop(G.currentZone, monster.tier || 1, monster.isBoss);
